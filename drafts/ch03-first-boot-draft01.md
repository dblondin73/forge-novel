...
Nate lowered himself to the running board of the truck and sat. Rex moved with him, pressing his flank against Nate's shin — not for comfort this time but positioning, the way he'd post up beside Nate when a coyote worked the fence line.
...
Then, through the quiet, a flicker of something came back along the connection: surprise. Not at what Nate had thought, but that he'd thought it _at_ him. That the line ran both ways.

When the voice came back, it was quieter. Careful. The tone of someone who'd just realized they'd been shouting in a stranger's kitchen and the stranger had a look on his face that suggested the shouting should stop.

"Can you hear me?"

"Hard not to," Nate said.

Rex looked up at him. Looked around the empty pasture — behind the truck, toward the Henderson place, along the tree line. Looked back at Nate. His tail twitched once in a way that clearly communicated: _There is nobody here and you are talking and I would like to formally register my concerns._
...
"I regret everything about this conversation already. Flint it is."
...
She could have told them. She could have told them both, right then, what this partnership would cost and what it would carry and the precise, beautiful, terrible ways it would change them. But that's not how good stories work — and this was going to be a very good story.
...
"No," Flint agreed, and something in his voice had quieted — the first moment since he'd woken up where the performance dropped and something genuine showed through, like catching a glimpse of wall through a crack in the wallpaper. "It's not nothing. It's one tool in an empty toolbox, which is — " He caught himself. The speed came back. "Which is still a profoundly concerning inventory for a man about to face whatever the **System** has planned. But I've seen worse toolboxes. Admittedly, I've been alive for twelve minutes, so my sample size is limited, but I'm going to count this as a win because the alternative is despair and I don't have the storage allocation for despair."

"That's more than I had ten minutes ago."

The silence that followed had texture to it — not empty but full, like the pause a man takes when someone's said something he wasn't expecting and he needs a second to decide whether to be annoyed or impressed.

"That is technically true." Flint's voice dropped half a register, slower now, the words spaced with more care. "I want to note for the record that saying something almost _optimistic_ while sitting on the running board of a truck with no weapons, no combat skills, and a heads-up display that couldn't track a sunset is either deeply admirable or profoundly concerning, and I genuinely cannot tell which. Are you an optimist? Please tell me you're not an optimist. I can work with a pessimist. I can work with a realist. I can even work with a man who checks the foundation before he trusts the roof. I cannot — and I want to be clear about this — I _cannot_ work with a man who just assumes the roof will hold because the sun is shining."

"I'm a systems engineer."

"Oh, thank — " The voice caught itself, swerved hard, overcorrected. "_Thank_ whatever authority is appropriate and listening. A systems engineer. So you understand that everything has a structure, everything breaks in predictable ways, and your job is to figure out _how badly_ before you figure out _what next._"
...
But Nate filed that thought the way he filed the headache — acknowledged, not acted on. He'd learned a long time ago that the most honest words came after a man ran out of rehearsed ones, and Flint hadn't run out yet.
...
"Checking the fence line. Then the water pump. Then the perimeter." Nate closed the tailgate and walked to the cab. "Then figuring out what we've got, what we need, and what's trying to kill us."

"That's — " Flint paused, and Nate felt a ripple of something that might have been surprise, and underneath it something that might have been relief. "That is an extremely rational prioritization sequence."

"It's what you do after a storm."

Nate climbed into the cab. The Ford was still idling — the low, steady patience of a machine that had no opinions about the end of the world.

"I feel compelled to point out," Flint said, and his voice had found something closer to its natural gear now — the dry, theatrical cadence of someone who'd rather talk than sit quiet and would rather be clever than vulnerable, except in the moments when honesty slipped out sideways before he could catch it, "that this is not, technically speaking, a storm."
...
"Fireballs. Small ones. Recreational, not combat. Lobbing them at the dirt pile behind the barn like a twelve-year-old who just discovered the world's most irresponsible baseball pitch." Flint's voice climbed half a register with each sentence, building the way a good punchline builds. "His class came through as **Apprentice Pyromancer**, which is either a legitimate starter track or someone at **System** headquarters has a sense of humor I was not briefed on. His mother has asked him to stop four times. His mother's requests are not being honored. His mother's voice is reaching a frequency that my audio parsing describes as 'escalating beyond safe operational thresholds,' which is the diagnostic way of saying she is about to _lose it._"

Nate almost smiled. Almost. "He's going to burn down the hay barn."

"He is _absolutely_ going to burn down the hay barn. It's not a question of if, it's a question of which throw. My over-under is six more before something catches. But that's a Henderson problem, not a Hall problem, and right now you're checking fence, so let's maintain our extremely rational prioritization sequence."
...
Flint was quiet for a moment — the full kind of quiet, the shape of someone else's thought pressing against the shared wall between them.

"You diagnosed that from sound alone," Flint said. Not a question.

"Inner race. Started three weeks ago."
...
"Right. Yes. Obviously. Just a man with a pump. Nothing to see here." A beat. "I'm filing this under the same folder as the unclassified subsystem, which is getting _concerningly full_ for my first hour of existence."
...
It took three stations to find something that wasn't static or screaming.

A woman's voice came through, calm enough to sound professional but with an edge underneath it that said the calm was costing her every dime she had: "— urging all residents to remain in their homes. Emergency services are overwhelmed in the Dallas-Fort Worth metroplex. If you or a family member has received what officials are calling a 'class assignment,' do _not_ — I repeat, do _not_ — attempt to use any abilities in populated areas. There have been multiple reports of —"
...
The morning was quiet. Insects in the grass. The pump grinding in the distance. The hum of a world that hadn't decided yet whether to panic or adapt, and was doing both at once, badly.
...
"Clear between here and town, if you're thinking about supplies."

"I'm thinking about the water pump."

"The water pump." A beat. "The world is on fire — in some cases literally, I refer you to the Henderson situation — and you want to fix a water pump."

"The world's been on fire before. Cattle still need water."

Somewhere in the south pasture, Congressman — an eighteen-hundred-pound Red Angus bull whose name was a long-standing editorial on the intelligence of elected officials — lifted his head, chewed once, and went back to grazing. The apocalypse had not yet affected his schedule. It was unclear whether anything short of an empty feed trough would.

"I want to be annoyed by that. I genuinely do." Flint's voice dropped lower, slower. "But it's the most operationally sound thing I've heard from anyone on this network in the last hour, and that includes the emergency broadcasts. You are a deeply frustrating man to disagree with."
...
Flint didn't mention the unclassified subsystem again. But Nate could feel him circling it — the way you could feel someone in the next room avoiding a piece of furniture they'd bumped into. Filing. Logging. Building a folder for something he couldn't name and couldn't stop noticing.

Behind them, the morning opened up wide and gold over the East Texas pastureland, and a meadowlark sang its three-note call from a T-post, and the world was changing into something none of them had asked for.
...
"That's a countdown," Flint said, and for the first time since he'd woken up, the performance was gone completely — no wit, no speed, no theatrical cadence. Flat and fast and stripped to the studs. The tactical register, and its arrival was itself a signal. "Nate. That is a countdown and I don't know what happens when it reaches zero."

**57**

"Helpful."

"I'm _aware_ that's not helpful. I'm telling you what I know, which is that a number is getting smaller and my entire knowledge base has nothing to say about what happens when it stops. My professional opinion is that it won't be a gift basket."
...
Not a departure. An erasure. One second the network chatter Flint was monitoring registered a twelve-year-old **Apprentice Pyromancer** — alive, present, probably mid-throw — and the next second the data point vanished like a line deleted from a spreadsheet. No transition. No movement. Just presence, then absence.

The mother's voice changed. The name became a scream.

"Children first," Flint said. His voice was working again but running on different fuel — not commentary but analysis, each word placed with the deliberate economy of a mind in tactical mode. "The **System** separated dependents before adults. Everywhere. All at once. Every child within my network range just — " He stopped. Started again. "Nate. I don't think this is optional."

**45**

Other voices joined from down the county road — parents, all of them, the sound of adults discovering that their children had vanished mid-step, mid-sentence, mid-breath, taken somewhere the screens couldn't show and the **System** wouldn't explain. The sound carried across the flat pastureland the way sound always carries in East Texas — too far, too clear, impossible to ignore.

**38**

"I'm getting fragments," Flint said, and his voice had found a gear Nate hadn't heard yet — rapid, precise, no jokes, the words stripped of everything except information. "**System** broadcast. Tutorial zones. Instanced. Separate from the physical world. That's — that's all I can pull. The broadcast is fragmented and my access is — " A pause that tasted like frustration. "I can hear the phone ringing but I can't pick it up. Whatever the Tutorial is, it's happening somewhere the **System** controls, and that's all I know."

**30**

Rex was looking at Nate. Not at the pasture, not at the tree line, not at the cattle shifting and lowing in the south field — disturbed by the sound of screaming that carried on the morning air like smoke from a fire you couldn't see. At Nate. Steady brown eyes, ears flat against his skull, body pressed low against the truck bed rail. A wash of heat through the look — not fear, not calm. Commitment. The bone-deep impression of _with you._
...
The world he arrived in was not the world he'd left.

Stone. That was the first thing — stone everywhere, underfoot and overhead and on every side, the close press of worked granite that smelled like wet mineral and old iron. Not a cave. Too regular. The walls were cut, the floor was level, the ceiling held at a height that was precisely one inch shorter than comfortable. Whoever built this wanted you to feel the weight of the rock above you. Mission accomplished.
...
"I have good news and bad news," Flint said, and his voice echoed strangely in the mental space they shared — the same voice, but the acoustics of Nate's mind had changed, as though the stone walls existed in more than one dimension. "The good news is I'm getting better signal in here. Whatever this Tutorial zone is, it's running on the **System's** local network, and local means closer, and closer means cleaner data. I can actually read some of what's in front of us."

"Bad news."

"The bad news is that what I'm reading says there are rooms ahead and the rooms have things in them and the things in them are not furniture."

Rex's nose hadn't stopped working since they'd arrived. The dog was pulling scent data from the air with the methodical urgency of a search team — cataloging, filtering, sorting — and what he was finding wasn't settling him down. A low whine, barely audible, pressed through his closed mouth. Not fear. Uncertainty. The sound of a dog who'd been given data that didn't match any category in his considerable library.

Nate looked down the corridor. It stretched ahead, curving slightly left, the torchlight making the far end glow amber. Two choices: forward or forward. The kind of design decision that gave you the illusion of exploration while funneling you exactly where it wanted you.

The green arcs pulsed at his periphery — still there, still faint, still the sorriest HUD in the history of heads-up displays. But present. Functional. Two thin green curves that said, at minimum: _you are alive, and you have the energy to keep being alive, and that's the only data point you need right now._

He took a step forward. Rex moved with him — pressed close, shoulder against calf, matching stride. Judge flanked right, growling at the wall brackets like the torches had personally offended her.

"For what it's worth," Flint said, and his voice was running in something between his default and his tactical register, the sound of a mind that was calculating and performing simultaneously and hadn't decided which one needed more resources, "your **Structural Analysis** is pinging. The walls are... I want to say 'real' but that's not exactly right. They're constructed. **System**-generated. The stone has the right density, the right mineral composition, the right thermal conductivity — it's a perfect copy of granite. But SA is flagging something underneath. A _framework._ Like looking at a movie set and seeing the two-by-fours behind the painted walls."

A counterfeit, then. A convincing one, but a counterfeit. The **System** had built a dungeon from scratch, loaded it with torches and stone and the appropriate amount of atmospheric menace, and dropped him into it with two dogs, two green lines, one skill, and a voice in his head that had been alive for less than an hour.

"Any other players?" Nate asked.

"Not within my immediate range, but my range is — " Flint made a sound that might have been a frustrated sigh if he'd had lungs. "Think of it like trying to use a metal detector on a beach, except the metal detector is broken and the beach is made of other metal detectors. I'm getting noise. Lots of it. Other people are in here — other Tutorial instances, maybe the same one, I can't tell. But I can't resolve individuals yet."

Nate nodded. Filed it. Kept walking.

The corridor opened after forty yards into a broader space — still stone, still torch-lit, but the ceiling rose to twice the height and the walls pushed outward into something closer to a room than a hallway. At the far end, a heavy wooden door, iron-banded, closed. At the center of the room, on a stone pedestal that looked like it had been waiting for someone to notice it, a faint blue glow. A **System** panel. Standard issue. The kind everyone else had been staring at since Integration.

Text appeared on the panel as Nate approached, and simultaneously in his own green arcs — the **System** speaking in two languages at once, translating itself for his nonstandard display:

**TUTORIAL — ROOM ZERO**
**PREPARE. EQUIP. PROCEED.**

Along the walls, weapon racks. Swords, axes, bows, staves, a collection that would have looked at home in a museum or a fantasy convention. Each one glowing faintly with blue light — **System**-generated, **System**-tagged, ready for assignment.
...
"Give me a second — SA is... it's doing something." A pause, and Nate felt the processing happening, felt Flint's attention narrow and focus the way a spotlight narrows on a stage. "The weapons are **System** constructs. Clean, standardized, mass-produced. They're fine. Functional. They'll do what they're supposed to do." Another pause, longer, and when Flint spoke again his voice had the particular quality of someone who'd expected to find one thing and found another. "But the _racks_ are interesting. The racks are made of real materials — wood and iron, not **System** constructs. The pedestal too. And the door. The room itself is made of real stone and real metal, and the weapons on the racks are the only things in here that are generated."

Real materials in a generated room. Tools built from scratch, sitting on shelves that were copies of something real. The **System** had built the dungeon out of actual architecture and stocked it with counterfeit weapons.

Nate's eyes moved from the racks to the room itself. To the iron brackets. To the wooden door. To the materials that **Structural Analysis** said were _real._

A plan was forming. Not the kind of plan he'd explain to Flint yet — the kind of plan that started with the bones and worked outward, the way every good build started, the way his father had taught him to look at a collapsed fence: _Don't look at the mess. Look at what's still standing._

"Interesting," Nate said.

"Nate. Why are you looking at the door like that? Nate. That is not how a man looks at a door he plans to walk through politely. Nate. What are you —"

"Looking at what I've got."

"You've got weapons. On the racks. That's what they're for. You pick one up, you go through the door, you fight whatever's behind the door. That is the _Tutorial's stated intent._"

Nate was already moving. Not toward the weapons. Toward the room.

"You're not going to take a weapon from the rack."

"I'm going to take the rack."

The silence that followed was perhaps the most eloquent thing Flint had produced in his forty-seven minutes of existence.

"I'm sorry," Flint said finally, and his voice had the careful, measured quality of someone making absolutely sure he'd heard correctly. "Did you just say you're going to take the _weapon rack?_"

"Part of it. The wood strut. Iron brackets. SA says the materials are real." Nate's hand was already on the rack, and through the contact he could feel what **Structural Analysis** was telling him — the grain of the wood, the stress lines, the places where the structure was strong and the places where it would give. "Real materials hold up better than copies."

"That is — I want to be clear — that is _not_ what the Tutorial intended."

"No," Nate agreed. "It isn't."

Another silence. Then, from the space behind his eyes, a sound that Nate would learn to recognize over the coming days and weeks and months — the particular frequency of Flint being simultaneously horrified and impressed, the exact noise a mind makes when it encounters someone who has looked at the rules, understood the rules, and calmly decided that the rules were more useful as raw materials than as instructions.

"I think," Flint said slowly, "this is the beginning of a beautiful and deeply concerning partnership."

Rex sat at Nate's feet, chin up, watching his person pull apart the Tutorial's furniture with the patient attention of a dog who'd seen his man fix stranger things than this and trusted the process even when it didn't make sense yet.

Judge had stopped growling at the torches. She was growling at the closed door now, which was either an improvement or a prophecy, depending on what was behind it.

The green arcs held steady. Two thin curves. Health and stamina. The sorriest HUD on the network.

And in the quiet room — the occupied space that had been there before the **System**, before Flint, before any of it — something stirred. Not guidance. Not instruction. Just the faintest warmth, the kind you feel when you've made a decision and something older than you agrees with it but isn't going to say so out loud.

Nate's hands found the first joint in the wood, and he began to build.

...
The chamber was forty feet across. Stone walls, arched ceiling, dim torchlight that made everything the color of bad coffee. Flint tagged the compass in Nate's peripheral — entrance behind them as north, spawn points ahead as south. Standard callout grid. Five more spawn points ripped open within three seconds of the first. Six Thornlings total — pulling themselves out of the stone with the jerky, root-finding motion of saplings in a time-lapse, if saplings had bark-plate armor and thorn-studded arms and the blind hunger of things grown to kill.

Marcus's voice cut through first — "Hold formation! **Warriors** engage, **Mages** second rank, HOLD!" — but the warriors were already charging before the words landed. The System had spent the last hour downloading one basic technique per weapon into their muscles — one swing, one stance, one way to hold the blade — and even that single skill wanted to be used — new truck, open road, foot itching for the gas. A big man with a longsword swung at the nearest Thornling with the jerky confidence of a man whose muscles had received instructions his body hadn't fully learned yet. The blade found the general area between shoulder and torso — not clean, not precise, but hard enough to bite into the bark-skin, and the Thornling screamed — the cracking sound of branches in an ice storm, high and wrong and not quite alive enough to feel sorry for.

Amber sap wept from the wound. Thick, viscous, the color of pine resin on a hot day. **Structural Analysis** read the wound site automatically — bark-plate compromised, fibrous interior exposed, stress fracture radiating from the point of impact. The longsword had done its job — not pretty, but the post was in the ground.

Two more **Warriors** closed on the Thornling beside it — a stocky woman with a mace and a teenager with a shield-and-shortsword combo who looked like he'd spent more time on a video game controller than a real grip. The mace woman's swing was textbook for the half-second the System steered it — wide arc, rotation through the hip, weight transfer perfect — and then her body lost the thread, the follow-through collapsed, and the head clipped the Thornling instead of crushing it. The kid did better. The shortsword was small enough that the downloaded technique didn't fight him as hard, and his thrust landed in the bark-plate flush. Not deep. But seated. He yanked it free with both hands and didn't fall over, which was Rank 1 Low at its current best showing.

"Every combat skill in this room is Rank 1 Low," Flint said internally. Tactical register — fast, no jokes, pure data. "Novice tier. The System downloaded aim, timing, technique — the knowledge is there, but their bodies are still arguing with the instructions. Think of it as a GPS in a car that doesn't have power steering."

Which explained the **Mage**.

She was maybe twenty-five, and the **Fire Bolt** she threw from the second rank hit a Thornling in the chest hard enough to ignite bark in a flare of orange light that made the whole room flinch. The System had given her the knowledge — how to gather mana, how to shape it, where to aim. But knowledge wasn't control. She'd panicked and dumped everything she had behind it — too much mana in a single cast, the magical equivalent of flooring a truck in first gear. **Structural Analysis** read the aftermath: surface burns, structural damage minimal. The Thornling staggered but didn't drop. The **Mage**'s hands were already dimmer. Somewhere a resource management tutorial was weeping.

"Six hostiles," Flint said. Still in tactical register — clipped, rapid, the wit dialed back but present enough that Nate could hear it waiting in the wings. "**Warriors** engaging four. Two breaking east toward the support line. The **Mage** overspent on that **Fire Bolt** — her hands are already dimming and the fight's twelve seconds old. At this rate she'll be standing dark in a room full of angry shrubs before the first minute."
...
The Thornlings didn't spook. No flight instinct to trigger — they weren't cattle, they were constructs, and constructs didn't flinch from a stare or a bark. Rex had figured this out in approximately four seconds and adapted. Instead of the patient eye-and-pressure that moved cattle through a gate, he was using active harassment — darting lunges, bump-and-break contact, rapid directional changes that kept the Thornling's root-legs guessing. Herding without the herding instinct to exploit. The dog had read the problem and rewritten the playbook on the fly.

Then Judge came in from behind like a forty-pound wrecking ball with opinions.

Where Rex circled and pressured, Judge charged straight at the Thornling's trailing root-legs and bit down with the focused aggression of a dog who had never once in her life considered a measured response. The Thornling's legs buckled. It tried to turn — Rex on the left, Judge on the right, neither where they'd been a second ago. Header and heeler. Rex steered it off the fence line. Judge drove it where Rex wanted it to go. The same partnership that had moved a thousand head of cattle through gates they didn't want to enter, applied to a three-and-a-half-foot murder shrub that had even less say in the matter than the cattle.

Its path bent east — away from the healers, toward open floor. Toward Nate's line of sight. Twenty feet.

Nate squeezed.

The prod snapped and the stock jumped in his hands — just a sharp vibration through the wood and a *thunk* that he felt in his wrists. The bolt crossed twenty feet of torchlit air and hit the Thornling in the left shoulder joint.

Not a kill shot. The bolt punched through bark-plate and sank three inches into whatever served as muscle underneath — dense, fibrous, the color of heartwood. The Thornling staggered sideways, its reaching arm dropping, momentum broken. Amber sap oozed from the wound, thick as honey. It turned toward Nate with a sound like roots tearing from soil, and for one second those dark knotholes that served as eyes locked onto him with the blank focus of a thing deciding whether he was worth killing before it died.

He was already reloading. Second rack bolt seated. Cocked. The prod took the tension — spring steel storing energy, ready to release it.

**Structural Analysis** fired on the staggered Thornling. The bark-plate armor resolved into detail: dense at the chest, thinner at the joints, a seam where the left shoulder plate met the torso plate that was wider than it should be. Growth patterns — compression lines in the bark running parallel to the limb axis, stress concentration at the joint where load-bearing requirements changed direction. Same as checking a fence line after a storm — you didn't need an engineering degree to see where it was about to give. You needed eyes and the patience to look.

He put the second bolt into the seam.

The impact was different this time. The bolt found the gap **Structural Analysis** had highlighted and sank to the fletching — through bark, through the fibrous interior, through whatever passed for a spine in a creature made of wood and spite. The Thornling seized, limbs locking, and collapsed forward onto the stone — a dull, wooden thud. Amber sap pooled beneath it, already darkening.

First kill.

The word sat in his chest with a weight he hadn't expected. Not guilt — he'd killed coyotes and copperheads and one rabid raccoon that had come up the porch steps at 2 AM. Killing a thing that was trying to kill people wasn't a moral question. It was logistics. But this was the first time the thing had been shaped close enough to a person, if you squinted, and the sound it made when it died was close enough to a voice that the difference mattered only because he chose to believe it did.

"First blood," Flint said, and if Nate didn't know better, he'd say Flint sounded impressed. "Two bolts, one kill. Your crossbow has a two-degree cant to the left, but for a weapon built from furniture by a man who had ten minutes and no instructions, I'll call it a passing grade. Barely."
...
"I was also going to mention the trigger delay, but since you're apparently running your own diagnostic now, I'll just sit here and feel professionally redundant."
...
Across the corridor, people were going still — eyes unfocused, heads tilted, the vacant scroll-face of people reading screens only they could see. Character sheets. They were reading whatever the System had given them. Some people scrolled with small finger gestures. Others talked quietly to their AI companions — the standard-issue System voices that Nate couldn't hear but could see in the way people tilted their heads and nodded at empty air.
...
Marcus's eyes were doing the same left-to-right scroll as everyone else's — reading something only he could see. "Blue panels. White text. Clean layout — health, mana, stamina, skill list with rankings, mana regen rate, experience to next level. Everything numbered, everything organized. Like a tactical display someone actually spent time designing." He paused. "It's good, Nate. Genuinely useful. I can see my party's health bars — everyone within thirty feet, their status in my peripheral. That's what **Vanguard** gives me." He paused again. "Why? Don't you have one?"
...
Marcus closed his character sheet and turned to look at Nate directly. The blue glow faded from his eyes — those panels were internal, invisible from outside, but the way someone's expression changed when they switched between interface and reality was becoming easy to read.

"So everyone else got the finished product," Marcus said slowly. "And you got—"
...
"Hey." Marcus's voice dropped half a register. "You built a weapon from a table leg that outperformed every sword on those racks. Don't tell me the System gave you nothing. It gave you something it didn't intend to, and that scares me more than any stat page."

Before Nate could respond, a sound from the far end of the rest area interrupted them — a sound like someone conducting an estate sale in the middle of an alien dungeon, because that was exactly what was happening.

---

## Crafting — Thorn Bolts

"SAVE THE THORNS."

Josie Pickett was elbow-deep in Thornling remains.

The warriors had dragged two of the six corpses into the rest area before they'd started dissolving — the System's cleanup protocol breaking down the creatures into component materials over a span of about ten minutes. Josie had intercepted the dissolution process with the focused urgency of a woman who had watched too many good things go to waste in her life and had decided, in this particular stone corridor on this particular impossible day, that waste stopped here.
...
"Being essential," Nate said.

He walked over to where Josie was working. She'd dumped her haul on the workbench — a crafting station sat against the west wall, wider than the ones in the starting room, with a mounted vise that **Structural Analysis** read as forged iron. Nine thorns, three bark fragments, and a glob of amber sap she'd scooped up with her bare hands and deposited in a bark-plate fragment repurposed as a container.

"These three are structural." She pointed to the largest thorns — dark, dense, slightly curved, each about eight inches long with a naturally tapered point. "These six are decorative garbage. They look the same, but they're not. The structural ones have stress lines at the base — decorative growths don't bear stress, so they don't develop the grain. These three will hold an edge. Those six will snap if you sneeze at them."

**Structural Analysis** confirmed it before she finished speaking. The three structural thorns had density — internal grain running lengthwise, the natural fiber alignment of a component that had spent its existence under load. Compression lines at the base, consistent with sustained weight-bearing. The decorative thorns were porous, brittle, grown to look like weapons without the material commitment of actually being one.

She was right. She was annoyingly, consistently right, and Flint was not handling it well.

"The fourth one," Flint said internally, his voice carrying the studied neutrality of someone about to lose an argument and hoping to control the terms of surrender. "The curved one she separated from the decorative pile. Fracture pattern indicates decorative origin — it wasn't load-bearing."

Nate picked up the curved thorn. Turned it in his hands. **Structural Analysis** read it and—

"My system is saying that one might be decorative," Nate said, hating the words as they came out.
...
"Your *system*—" she held the thorn up, "—is wrong." She ran her thumb along the base, tracing a ridge Nate hadn't noticed. "See this? Stress line. Right there." She paused, blinked — the look of someone hearing words in her head that she hadn't known before and deciding to trust them anyway. Her **Appraiser** class feeding her data she translated into language that sounded like experience because it built on experience. "It's subtle because the growth pattern curved, but the base still bears load. Decorative thorns don't ridge at the base because they never had to hold anything up. This one did. It bent under pressure instead of breaking, which means the density is actually *higher* than the straight ones because it had to compensate for the curve."

**Structural Analysis** recalibrated. She was right. The ridge was there — a subtle compression line at the base that indicated load history. The curve had masked it, but the evidence was in the material.

"She's right," Flint said internally. The tone of an AI that would rather eat its own code than admit a woman with no sensors and a makeshift sack had out-diagnosed his material analysis. "The curve compressed the stress markers. I was reading the exterior geometry. She was reading the material history. Her method is—" A pause that was definitely not a processing delay. "Technically more thorough than mine."

"Don't worry about it," Nate said internally.

"I'm not worried. I'm cataloging. There's a difference. The difference is that cataloging doesn't require emotional processing, which I am definitely not doing."

"She's right," Nate said out loud.

Josie pointed at him with the thorn. "I know."

The first Flint-Josie clash — won by Josie on points, with Flint contesting the scorecard from inside Nate's skull. It would not be the last.

Nate took the four structural thorns and set them on the workbench. The vise was forged iron, solid, metalwork that **Structural Analysis** read as honest — same integrity as the table legs in the starting room. Built to hold things, not to impress anyone.
...
Then the Thornling fibers. Josie's scrap pile had a handful — long, dense strands pulled from the creatures' interiors before they dissolved. Nate wound them around each shaft below the thorn head, and **Field Repair** bonded them into the wood. The rack bolt's soft grain hardened under the reinforcement — the fibers adding density and rigidity the original shaft had never had.

Last step — he filed each thorn tip to a finer point. Not because they needed to be sharper — the natural taper was already lethal — but because **Structural Analysis** had shown him where the density concentrated, and refining that taper would let the head find gaps in bark-plate armor — a key returning to its lock. A thorn knew bark. It had spent its existence embedded in bark, growing through bark. Turn it around, give it velocity, and it would find every seam and weakness because those were the paths it already understood.

The Tutorial's creatures as ammunition against itself.

Four bolts. Ten minutes. Thorn heads on reinforced shafts — heavier than the originals, the center of mass shifted forward by the dense heads. The straight thorns would fly true. The curved one would pull right by a degree, but it was denser, and Nate filed a compensating flat on the socket that would correct the drift.

"You made my thorns into weapons," Josie said. She'd been watching the whole process with the fixed attention of a woman who had found the most interesting thing in the room and was not going to look away until she understood it completely.

"They were always weapons. They just needed a delivery system."

She stared at him for two full seconds. Something moved across her face — not the cataloging look, not the inventory scan, but something warmer that she shuttered before it could settle.

"That is the most romantic thing anyone has ever said to me about projectiles."

From that space behind his eyes, Flint murmured: "I'm archiving that sentence. Not for tactical purposes. For personal enrichment."
...
And the Thornlings themselves moved differently. The Room 1 spawns had pulled themselves out of stone with single-purpose root-finding — head down, target acquired, walk forward, hit the closest thing. These ones lifted their knothole eyes first and *looked.* Brief — half a second per spawn — but they swept the room before they advanced. Reading the warrior line, the **Mage** on the second rank, the unarmed knot in the back. The System had watched the Room 1 fight and updated the spawn behavior — added a target-priority pass that the basic Thornlings hadn't had. Same monsters. New software.
...
The **Mage** — the same young woman from Room 1, hands already bright with gathered mana — threw a **Fire Bolt** at the nearest Thornling. Direct hit, bark igniting in a crack-hiss of sap on superheated wood. She threw a second before she could think about the first. Not courage. Reflex. The second bolt hit. The Thornling dropped, bark-plate splitting, amber sap spraying across the stone.
...
A **Warrior** intervened — the woman who'd been fighting on the front line since Room 1. Two rooms of constant swinging had worn her base technique into something that actually worked — not polished, but practiced, her body starting to believe what the System had downloaded. She drove the Thornling off the teenager with two quick cuts and a shove that used the blade's flat as a battering ram. The Thornling went down.

And as it dropped, something flared around her — a brief pulse of golden light, a chime that Nate couldn't hear but could see in the way her stance shifted and her mouth opened in a small *oh*. Flint's glitchy combat log flickered — fragments of data from a network Flint shouldn't have been reading: **[SWORD TECHNIQUE — RANK 1: LOW → MID. ENHANCED OPTION UNLOCKED: POWER STRIKE.]** Her next swing was different. Faster, tighter, the blade glowing faintly as the System guided it into the seam of a Thornling closing from her left. The first System-assisted strike Nate had seen — not just downloaded knowledge, but active guidance, the System steering her arm through the motion. It hit harder than anything she'd thrown before.

She was already looking for the next target with the hungry focus of someone who wanted to feel that chime a second time.

*And there it is.* The loop. The reward architecture laid bare. Skill milestone — her basic sword technique had ticked from Low to Mid within Rank 1, not even a full rank-up, just a sub-tier, and the System gave her a golden chime and a light show for it. Nate had seen this exact design in a dozen games. Reward the smallest progress with the biggest fanfare. Make the click feel good. Make the player chase the next click.
...
The thorn head found the seam between bark plates like it remembered the way home — wood returning to wood, a material designed to exist inside bark understanding the architecture of bark from the inside out. The bolt buried itself to the base, amber sap erupting from the wound in a thick spray, and the Thornling dropped straight down — every limb going slack at once.

One bolt. One kill. At thirty feet. With ammunition made from the last room's corpses.

"DID YOU SEE THAT?" Josie's voice from behind the line, vibrating with the intensity of a woman who had just watched raw materials she'd personally salvaged perform their intended function in the field. "MY THORN DID THAT."

"Your thorn, my crossbow," Nate said, reloading.
...
The third wave — rear spawns — had put two Thornlings behind the support line, and one was heading for the **Mage**. The same **Mage** who'd burned through most of her mana and was standing with dimmed hands, unaware of the bark-covered thing closing low and fast from her blind side.

Rex appeared on the Thornling's left flank. Not running — *working.* Low to the ground, body compressed into the crouch that Nate had seen a thousand times on the ranch. He darted in, snapped at the trailing root-leg, and peeled away before the thorn-arm could swipe — a bump-and-break that forced the creature one step left. Then another dart, another bump, another step. Not biting to damage. Biting to *steer.*

Judge didn't steer. Judge hit the Thornling's back legs like she was being paid by the impact and had a quota to meet. Her teeth found the trailing root-ankle and she wrenched sideways — not a nip, not a redirect, but the full-commitment bite of a heel dog who believed that anything still standing behind the header was her personal responsibility.

The Thornling's path bent — away from the **Mage**, toward a **Warrior** who had line-of-sight and a sword ready. The creature didn't decide to change direction. It was *herded.*

The **Warrior**'s blade connected. The Thornling went down. Rex broke off with quiet efficiency. Judge broke off half a second later and barked once at the corpse — sharp, final — case closed.
...
"Thorn bolt penetration is exceeding rack bolt performance by approximately triple," Flint said. "Which means your girlfriend's material salvage is the single largest force multiplier in this room, and I'm going to be insufferable about the implications of that."
...
The fight was finding its noise. Bark-on-stone footfalls layered with the wet crack of thorn-arms hitting raised shields. Sword work on the front line — heavy, repetitive, the rhythm of men chopping wood faster than wood was meant to be chopped. The smell had thickened: scorched sap from the **Mage**'s first bolts, iron from a **Warrior**'s shoulder gash, sweat and adrenaline and the mineral dust still settling out of the air. Marcus's voice cut through the layers in flat, even calls — a man air-traffic-controlling a fight by ear because there were too many vectors to track by sight.
...
The spawn points fired in the familiar stagger — two, pause, three, pause, three. But the ninth spawn point, in the center of the room, pulsed with a different rhythm. Slower. Deeper. Whatever was coming through that point was bigger.

The proto-guard emerged like a tree growing in fast-forward. Bark-plate armor twice as thick as the basic Thornlings. Arms that ended in thorn clusters dense enough to shred chain. It stood seven feet tall and moved with a deliberation that the basic Thornlings didn't have — not rushing, not mindless, but *considering.* Reading the room — bull in a pen, measuring every direction for threat and escape.

About eighteen hundred pounds of bad attitude deciding where to charge. Nate had dealt with that math before. Congressman — his registered Red Angus herd bull — had the same energy when the vet showed up. Except Congressman eventually calmed down when you scratched behind his ears. This thing didn't have ears, and Nate doubted it would appreciate the gesture.

**Structural Analysis** fired hard. The proto-guard's armor was denser, yes, but density had structure, and structure had seams. The arm joints were thicker than the basic Thornlings' but the growth pattern was the same — bark plates overlapping at the joints, the seams narrower but present. The shoulder-to-torso connection showed a gap where the heavier armor hadn't fused completely. Material composition consistent with the base Thornlings but with additional compression layers at the chest — load-bearing armor, not decorative. The creature was between a basic Thornling and whatever came next — bigger, tougher, but still growing into itself. A draft before the final version.
...
Whatever the **Vanguard** class was giving him, Nate could see the effect — fighters moving before Marcus finished speaking, adjusting positions they shouldn't have known to adjust, responding to tactical data pushed from his class interface. Twenty years of leadership — first Marines, then government contractors, now this — and the System had given him tools that matched what he already was. Marcus Webb with System tools was the same thing as Marcus Webb with a rifle squad: the most dangerous organizing force in any room that contained him.

"**Warriors** hold the choke between those rocks!" His voice carried with the flat authority of a man giving orders he expected followed. "Two-man front, rotate on cooldown. **Mage** — you see that elevation on the east side? Line of sight to the center. Burst fire, then *wait.* Let mana regen. Do not burn dry." He looked directly at her. "You've got four bolts in you before you're dark. Use three and hold one in reserve. Three." He held up fingers. The **Mage** nodded. "**Healer**, behind the **Warriors**, do NOT advance. If the line moves to you, back up. Let them come to your range."

Tank. Healer. DPS. The holy trinity of every MMO Nate had ever touched, forming in real time in a stone room sixty feet across with real blood and real consequences. Marcus was running the fight as an RTS — top-down, unit placement, resource allocation. Every fighter a piece on a board only he could see fully.
...
A Thornling clipped one warrior's shin — bark-thorn raking across the calf, a hot line of blood through torn pants. He grunted, didn't drop. The blade kept coming on the upswing because the System had carried his arm through the motion and the System didn't care that he'd just been hit. Behind him, the second warrior took the lead with his **Power Strike** ready, and the first man stumbled back into rotation breathing hard, hand pressed to the cut, eyes already counting the seconds until cooldown made him useful again. The choke held because two rough men were swapping the lead beat with the metronome rhythm of dancers who had no idea they were dancing.

The **Mage** scrambled to the elevation — a rock shelf four feet up, wide enough to stand, sight lines clear to the center where the proto-guard was advancing. She threw a **Fire Bolt**. Controlled this time — less mana in the cast, tighter beam, the bolt traveling in a focused line instead of a flare. The lesson from Room 2 applied. The bolt hit a basic Thornling and it dropped. Progress. Real, visible, earned progress.

Then she waited. Hands dimming, mana regenerating, the discipline of a woman who'd burned too hot twice and had learned what dry felt like.

Nate took the elevation two positions east of the **Mage**. Higher ground. Crossbow rested on a rock shelf that **Structural Analysis** had already measured as stable — flat surface, correct height, natural shooting rest. Behind the warrior line, above the fight, sight lines to every corner of the room.

"Nate." Marcus's voice, directed and sure. "The big one. Center. Tell me what you see."

**Structural Analysis** was already reading the proto-guard. The creature had paused at the center of the room — not confused, but assessing. Its knothole eyes moved across the warrior line, the elevated **Mage**, the **Healer** position. Predator reading a herd. Looking for the gap.

"Arm joints are the weakness. Bark plate is too thick at the chest for anything short of a **Mage** burst to crack, but the joints overlap with narrow seams. Left shoulder has a growth gap — the armor plates didn't fuse where the load-bearing requirements change direction. That's your entry point." He paused. **Structural Analysis** was painting more data across his vision, the spawn points along the room's perimeter still cycling. "And the spawn points on the south wall are about to fire again. Thirty seconds, maybe less."

"**Warriors** — south wall, thirty seconds!" Marcus relayed without hesitation. A man who'd spent his career turning field intel into fire orders didn't need to understand **Structural Analysis** to trust the source. "Nate, the big one is yours. Slow it down. Don't kill it — pin it. We finish it when the adds are clear."

Marcus read people. Nate read architecture. Between them, that covered the room.

Nate sighted on the proto-guard's left shoulder. The gap **Structural Analysis** had highlighted was narrow — two inches of exposed fibrous interior between overlapping bark plates. At forty feet, with a handmade crossbow that had a two-degree left cant he was compensating for by feel, that was a challenging shot. On the ranch, it was the equivalent of dropping a coyote through a gap in the brush at fifty yards with a rifle that pulled left — one window, and the margin was measured in inches.

First thorn bolt. The bolt found the gap and sank three inches into the shoulder joint, amber sap erupting from the wound. The proto-guard staggered, its left arm dropping, the reaching thorn-cluster going limp. Not dead. Not close to dead. But its strongest arm was compromised and its advance slowed from deliberate to labored.

The south-wall spawn points fired. Three Thornlings. Thirty seconds, as promised. The warriors rotated — two peeling off to face the new threat while two held the choke. Marcus called the rotation without raising his voice, and the fighters moved like they'd been doing it for months instead of minutes.

Rex was everywhere and nowhere. Working the perimeter through the entire fight — not engaging, never engaging, but appearing wherever a Thornling's path threatened a non-combatant. He'd herded one into the warrior line with three precise bumps. He'd cut off another that was circling toward the **Healer** position. Each intervention lasted seconds. Each one redirected a threat before it became a crisis. Three rooms in, and his herding instincts had fully adapted — the patience-and-eye approach discarded for active harassment that moved creatures who had no flight instinct to exploit.

A Thornling circled toward the **Mage**'s elevated position. Rex materialized on its flank — snap at the root-leg, peel away, snap again — bumping it two steps left into a **Warrior** whose blade was already swinging. The Thornling went down. Rex had moved on before it hit the floor. The **Mage** never saw the threat.

Judge held the south wall. Rex ghosted through — a thought with teeth. Judge held ground — a statement with jaws — forty pounds of Blue Heeler planted between the rear-spawn corridor and the support line, barking at anything that came through with the authority of a dog who had decided that this was her fence line and she would die on it before she'd let something past.

A Thornling tested her. It came around the south corridor's elbow at a low half-run, root-legs scrabbling for traction on the smooth stone, and Judge launched off her hindquarters like she'd been waiting for an invitation since Room 1. Her bite found the trailing root-ankle and she set her weight backwards — forty pounds of compact muscle anchored against the creature's forward momentum. The Thornling pitched, recovered, swung a thorn-arm at her and missed by a foot because she'd already let go and circled. By the time it had its balance, a **Warrior** had crossed the gap. Judge barked once at the kill — sharp, possessive — and reset her stance at the corridor mouth. The fence line held.

Second thorn bolt into the proto-guard's right arm joint. **Structural Analysis** had mapped the seam while the creature was staggering from the first hit — the armor plates shifting, new gaps opening as structural integrity on the left side compromised the right. The bolt punched through bark and the proto-guard's right arm locked at the elbow.

Third bolt. The curved one — Josie's vindicated thorn, the one Flint had called decorative and Josie had proved structural. Nate compensated for the rightward pull, aimed for the shoulder gap that had widened as the creature's damaged arms pulled the chest plates apart. The bolt flew true — the compensating flat he'd filed into the base correcting the drift — and buried itself in the shoulder-to-torso gap. Amber sap sprayed in a thick arc.

The proto-guard seized. Both arms locked. Its advance stopped completely, seven feet of bark-armored proto-monster standing in the center of the room — rooted, locked, a dead tree still vertical.
...
The room exhaled. For two seconds — maybe three — there was no sound but heavy breathing and the soft *tock-tock* of amber sap beading off the proto-guard's carcass onto the stone. The **Mage** was hunched on her ledge, hands at her knees, mana faintly visible at her fingertips like coals banked under ash. The smell was overwhelming: scorched sap, iron, dust, and the green-wood reek of split bark concentrated into the lowest fifty feet of breathing room they had. Two of the warriors were laughing — a short, ugly sound that had nothing to do with humor and everything to do with adrenaline that had nowhere to go.

But the room had done what the room was designed to do.

The rock formations that made positioning possible also made isolation possible. A **Warrior** — young, linebacker-sized, one of the stronger fighters in the group — had pushed too far east chasing a Thornling into a corridor between two stone ridges. Good instinct, bad geometry. The corridor narrowed. His sword arc shortened. Two Thornlings came around the far end and caught him from a direction his blade couldn't reach. He killed one. The second killed him. By the time another fighter reached the corridor, the young man was on the stone and the Thornling was already moving on to easier targets.
...
Not toward a Thornling. Not toward a threat. Toward a point in the empty air six feet from where Nate stood, where there was nothing — no spawn point, no creature, no architecture that **Structural Analysis** registered. Rex stared at the nothing with both ears forward and his tail held perfectly still, the posture of a dog who had seen something that existed outside the spectrum his person could perceive.

Then it was gone. Whatever Rex had seen — or sensed, or felt — passed. His ears relaxed. His tail swept once. He looked back at Nate with an expression that was not distress, not warning, but *recognition.* As if something he'd been waiting for had looked back at him and he was satisfied.

"Flint. Did you catch that?"

Silence. The kind of silence Flint filled when he didn't want to answer a question directly. The halting, uncharacteristic pause that happened when Flint could tell Nate something and was choosing not to.

"Catch what?"

"Rex just—" Nate stopped. The gold was gone. Rex was back to scanning the room. The moment had passed like a deer crossing a trail — there and gone and impossible to prove.

"I registered a minor sensor anomaly," Flint said, after a pause that was definitely not a processing delay. "Probably interference from the proto-guard's dissolution. Higher-density material breakdown produces residual energy signatures that can—"

"You're making that up."

Another pause. "I'm *extrapolating* from limited data. Which is different from making things up in that it sounds more credible and I can cite sources."

Flint had seen something. And Flint had decided, in the space between detection and report, not to say what it was.
...
"The sight reduces your point-of-aim error by roughly forty percent at distance," Flint said. "Which is a meaningful improvement, and I want you to note that I said 'meaningful' instead of 'adequate' because I'm being generous. I also want you to note that I'm being generous, because I intend to bring it up later when you do something I disapprove of."
...
She'd set up shop three crafting stations down — not literally, but the energy was unmistakable. Josie Pickett had arranged her salvage on the workbench surface in a display that would have been at home in any estate sale in East Texas: materials sorted by type, quality, and potential application, each category separated by precise spacing that said *I know exactly what everything here is worth and I am prepared to negotiate.*

"Does anyone need bark-plate fragments?" Her voice carried the length of the corridor. "I have twelve now. The three-layer laminate ones, not the garbage single-layer. These are the good ones — interlocking grain, stress-tested, material that would make excellent shield facing or armor reinforcement if anyone here has the crafting skills to work them."

The leather-worker from the first rest area approached. And behind her, a man with a tinkerer's kit and a woman who'd been given a weaver class. Three crafters, drawn to Josie's workbench like iron filings to a magnet, because Josie Pickett had something none of them had: raw material, pre-sorted, quality-graded, ready to work.

"Oh, you came back!" Josie beamed at the leather-worker. "Did you finish the arm guard? I have better stock now — the Room 3 Thornlings had denser bark plate, thicker grain. The Room 1 stuff was fine but this—" She held up a fragment. "Feel that. *Feel* it. That's combat-grade laminate. The Room 1 fragments were practice. These are the real deal."
...
Nate scratched behind Rex's ears with one hand and rested the other on Judge's neck. For a few seconds the Tutorial was somewhere else — just a man and his dogs sitting together — same positions, same quiet, a thousand evenings after the cattle were in and the work was done.
...
Marcus smiled. Not the boardroom smile — the real one, the one that cracked through the command face like sunlight through a closing door.
...
Ears lifting first, then the head, then the rest of him — unhurried — porch-nap to truck-engine, zero to ready in a breath. Not startled. Not coiled. Just *ready,* the switch from companion to working dog so seamless it barely looked like a switch at all. The torchlight caught his eyes and they reflected amber, and in that amber was the same thing that had been there since the pasture: certainty. Not that everything would be fine. Just the quiet certainty that the man beside him would handle whatever came next, because the man beside him had always handled whatever came next, and a dog who'd never been let down didn't know how to expect disappointment.

Judge was already on her feet. She'd gone from dead asleep to combat-ready in the time it took to blink, which was Judge's entire philosophy of life compressed into a single motion. She stood at Rex's flank, ears pinned forward, stub tail rigid, staring into the dark corridor with the expression of a dog who had taken a personal interest in whatever was down there and intended to express that interest with her teeth.

The corridor beyond was dark. The torchlight didn't reach far enough to see what waited, and **Structural Analysis** found only stone and shadow and the faint, rhythmic pulse of spawn points warming in the deep.

Nate set the crossbow across his knees. Seven bolts — three thorn-tipped, four reinforced rack. A peep sight filed from a wall bracket. A forging hammer on his belt. Two dogs at his knee. A voice in his head that knew more than it was saying and had started making choices about when to share.
...
Judge didn't wait for a tail sweep. She was already walking into the dark.

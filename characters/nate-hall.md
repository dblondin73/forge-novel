...
- Father died young; stepped up to help his mother run the ranch
...
- **Type:** Fighter-pilot HUD overlay (NOT a blue screen)
- **Evolution:** 4 phases
  1. Basic (Book 1) — monochrome, barely noticeable
  2. Tactical (Book 2) — color, threat indicators, first rune patterns visible
  3. Analytical (Books 3-4) — structural analysis, crafting ID, sees Labyrinth architecture
  4. Authority (Books 5-7) — hidden stats, System process logs, root access
...
During a **sunrise horseback ride** checking his cattle, he spots a mythological stag on his property. Beautiful but wrong — eyes too bright, movements too fluid. He observes it before it notices him. The moment the stag **locks eyes with him**, the System tutorial triggers immediately.

- Tutorial boots sensation and interface first
- Overlay reveals gradually over reality
- Holy Spirit rewrites the corrupted System AI before it boots
